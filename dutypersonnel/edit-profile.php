...
$sql=mysqli_query($con,"Update dutypersonnel set specialization='$dutyspecialization',dutyName='$dutyname',address='$dutyaddress',contactno='$dutycontactno' where id='".$_SESSION['id']."'");
if($sql)
{
echo "<script>alert('Duty Personnel details updated successfully');</script>";
...
<html lang="en">
	<head>
		<title>Duty Personnel | Edit Duty Personnel Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Duty Personnel | Edit Duty Personnel Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Duty Personnel</h5>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from dutypersonnel where dutyEmail='".$_SESSION['dlogin']."'");
...
<hr />
							...
							<input type="text" name="Dutypersonnelspecialization" class="form-control" required="required" readonly="readonly" value="<?php echo htmlentities($data['specialization']);?>">
...
<div class="form-group">
					...
					<input type="text" name="dutycontact" class="form-control" required="required" maxlength="11" value="<?php echo htmlentities($data['contactno']);?>">
														</div>
