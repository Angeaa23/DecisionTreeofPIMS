...
$query=mysqli_query($con,"update dutypersonnel set password='$newpassword' where contactno='$cno' and dutyEmail='$email'");
if ($query) {
...
<html lang="en">
	<head>
		<title>Duty Personnel Password Reset</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> RHU | Duty Personnel Reset Password</h2></a>
				</div>
