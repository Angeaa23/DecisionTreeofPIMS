...
$sql=mysqli_query($con,"Update doctor set specialization='$docspecialization',fullName='$docname',address='$docaddress',contactno='$doccontactno',email='$docemail' where id='$did'");
if($sql)
{
