...
{
$sql=mysqli_query($con,"insert into doctorspecialization(specialization) values('".ucwords($_POST['doctorspecialization'])."')");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="text" name="doctorspecialization" class="form-control"  placeholder="Enter Doctor Specialization" required autocomplete="off">
														</div>
